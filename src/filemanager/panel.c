...
WPanel *
panel_new_sized_empty (const char *panel_name, int y, int x, int lines, int cols)
{
    WPanel *panel;
    Widget *w;
    char *section;
...
WPanel *
panel_new_sized_with_dir (const char *panel_name, int y, int x, int lines, int cols,
